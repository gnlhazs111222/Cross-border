...
import { reviewCasesBoundary as reviewCases } from './boundary-cases';
...
const dir = resolve('artifacts/evaluation/review-boundary', runId);
...
const report = () => ({ runId, datasetHash, datasetVersion: 1, labelProvenance: 'AI-authored synthetic; NOT human reviewed',
  independentEvaluationMeaning: 'Separate fixed expected labels and runner; not an independent human benchmark. Boundary probes are visible, AI-authored development cases; no blind holdout.',
