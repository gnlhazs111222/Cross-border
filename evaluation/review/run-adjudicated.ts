...
import { reviewCases, labelHash, labelVersion } from './adjudicated-cases';
...
const dir = resolve('artifacts/evaluation/review-adjudicated', runId);
...
const report = () => ({ runId, datasetHash, labelHash, labelVersion, batch: Number(process.env.REVIEW_BATCH), datasetVersion: 1, labelProvenance: 'User-authorized AI secondary adjudication; NOT independent human labels',
