...
export function SupplierImport({ onDatasetChange }: { onDatasetChange: () => void }) {
  ...
  return <>
    <section className="panel supplier-import-panel">
      ...
      <div className="supplier-file-links"><span>{t('Download sample:')}</span><a href="/demo/haitao-supplier-demo.xlsx" download><Download size={13} />Excel (.xlsx)</a><a href="/demo/haitao-supplier-demo.csv" download><Download size={13} />CSV (.csv)</a></div>
