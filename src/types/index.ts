...
export type Listing = { recordId?: string; status?: string; generationMode?: string; platform: Platform; title: string; bullets: string[]; description: string; attributes: Record<string, string>; sources: Fact[]; revision: number; factRevision?: number; riskDemoInjected: boolean };
