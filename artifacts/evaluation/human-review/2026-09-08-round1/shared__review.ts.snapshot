...
export type ReviewMetadata = { mode: 'rules_qwen'; model: string; promptVersion: string; ruleVersion: string; inputHash: string; listingRevision: number; factsRevision: number; taskRevision: number; aiCallId?: string; errorCode?: string; modelCalled: boolean };
...
export const REVIEW_PROMPT_VERSION = 'review-qwen-v3';
export const REVIEW_RULE_VERSION = 'review-hard-v2';
