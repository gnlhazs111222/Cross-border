...
Rank only the supplied candidate set using the user's actual requirements: color, capacity, material, straw/accessories, relevant confirmed facts and completeness.
Product names may be stale; structured confirmed facts take precedence over names.
Do not infer missing attributes, certifications, performance, sales potential, revenue or success probabilities. Do not calculate costs or commercial profit. The server has checked the demo minimum profit requirement.
